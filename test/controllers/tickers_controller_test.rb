...
class TickersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ticker" do
    assert_difference('Ticker.count') do
      post tickers_url, params: { ticker: { company_name: @ticker.company_name, ticker: @ticker.ticker } }, as: :json
    end
  ...
  test "should update ticker" do
    patch ticker_url(@ticker), params: { ticker: { company_name: @ticker.company_name, ticker: @ticker.ticker } }, as: :json
    assert_response 200
  end
